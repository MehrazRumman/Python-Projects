...
class MainWindow:
    def __init__(self, root):
        ...
        tk.Label(self.root, text="").grid()
        tk.Label(self.root, text="").grid()
        self.b1 = tk.Button(self.root, text="Round Robin", font="verdana 12 bold", bg="yellow", width=15,
                            command=partial(self.roundrobin, "ROUND-ROBIN")).grid()
        tk.Label(self.root, text="").grid()
        self.b2 = tk.Button(self.root, text="FCFS", font="verdana 12 bold", bg="yellow", width=15,
                            command=partial(self.roundrobin, "FCFS")).grid()
        tk.Label(self.root, text="").grid()
        self.b2 = tk.Button(self.root, text="SJF", font="verdana 12 bold", bg="yellow", width=15,
                            command=partial(self.roundrobin, "SJF")).grid()
        tk.Label(self.root, text="").grid()
        self.b2 = tk.Button(self.root, text="SRTF", font="verdana 12 bold", bg="yellow", width=15,
                            command=partial(self.roundrobin, "SRTF")).grid()
        tk.Label(self.root, text="").grid()
        self.b2 = tk.Button(self.root, text="PS", font="verdana 12 bold", bg="yellow", width=15,
                            command=partial(self.roundrobin, "PS")).grid()
        self.frame.grid()
...
class robin:
    def __init__(self, root, rr, algo):
        ...
        if "PS" == algo:
            ...
            tk.Label(self.rr, text="").grid()
            self.butt = tk.Button(self.rr, text="Higher Value", command=partial(self.Choices, "HV")).grid(row=15,
                                                                                                          column=0)
            self.butt = tk.Button(self.rr, text="Lower Value", command=partial(self.Choices, "LV")).grid(row=15,
                                                                                                         column=1)
            tk.Label(self.rr, text="").grid()
            z = 5
    ...
    def calculaterr(self):
        ...
        if (self.algo == "ROUND-ROBIN"):
            obj = RoundRobin(self.a11.get(), self.a22.get(), self.a33.get(), self.a44.get(), self.a55.get(),
                             ...
                             self.c11.get(), self.root, self.rr, self.calrr, self.algo)
            obj.processData()
        elif (self.algo == "FCFS"):
            obj = FCFS(self.a11.get(), self.a22.get(), self.a33.get(), self.a44.get(), self.a55.get(), self.b11.get(),
                       self.b22.get(), self.b33.get(), self.b44.get(), self.b55.get(), self.root, self.rr, self.calrr,
                       self.algo)
            obj.processData()
        elif (self.algo == "SJF"):
            ...
            obj = PS(self.a11.get(), self.a22.get(), self.a33.get(), self.a44.get(), self.a55.get(), self.b11.get(),
                     ...
                     self.p33.get(), self.p44.get(), self.p55.get(), self.root, self.rr, self.calrr, self.algo,
                     self.choice)
            obj.processData()
        return
...
class Displaydata:
    ...
    def Display(self):
        ...
        if (self.algo == "ROUND-ROBIN" or self.algo == "SRTF"):
            ...
            tk.Label(self.calrr, text=" ").grid()
        self.b1 = tk.Button(self.calrr, text="BACK TO MENU", font="verdana 11 ", width=15, command=self.BackMenu).grid(
            row=19, column=0)
        tk.Label(self.root, text="").grid()
        self.b1 = tk.Button(self.calrr, text="BACK TO {}".format(self.algo), font="verdana 11 ", width=18,
                            command=self.Back).grid(row=19, column=1)
        tk.Label(self.root, text="").grid()
        self.b1 = tk.Button(self.calrr, text="EXIT", font="verdana 11", width=15, command=self.EXIT).grid(row=19,
                                                                                                          column=2)
        tk.Label(self.root, text="").grid()
